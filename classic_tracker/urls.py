...
from .views import HomeView, DashboardView, DayListView, DayUpdateView, DayDeleteView, DayCreateView, DayDetailView, \
...
urlpatterns = [
    # Cache the application homepage forever as it does not change
    path(
        '',
        cache_page(None, key_prefix='classic_tracker_home')(HomeView.as_view()),
        name='home'
    ),
